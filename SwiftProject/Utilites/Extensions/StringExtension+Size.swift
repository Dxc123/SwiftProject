...
extension String{
    /// 计算字符串的尺寸
    public func getTextSize(rectSize: CGSize, fontSize: CGFloat) -> CGSize {
    ...
    /// 根据字符串以及字体->返回文本的尺寸
    public func getTextSize(string: String, font: UIFont,size: CGSize) -> CGSize {
    ...
    public func getTextSize(font:UIFont,width:CGFloat)-> CGSize{
