...
extension UILabel {
    ...
    ///   - width: 文本宽度
    /// - Returns: Lab高度
    public class func getLabHeight(_ title: String, font: UIFont, width: CGFloat) -> CGFloat {
    ...
    ///   - font: 文本大小
    /// - Returns: 文本宽度
    public class func getLabWidth(_ title: String, font: UIFont, height: CGFloat) -> CGFloat {
