...
extension Date {
    ...
    public func getCurrentDate(format: String) -> String {
    ...
    /// 获取当前时间戳
    public static func getCurrentStamp() -> Int {
        let date = Date()
    ...
    public func getCompareCurrentTime(dateStr: String, dateFormat: String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = NSTimeZone.local
        dateFormatter.dateFormat = dateFormat
